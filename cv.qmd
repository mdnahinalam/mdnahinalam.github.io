...
-   Conduct data analysis using R and Python to support oceanographic research.

-   Prepare research reports on marine environmental studies.

-   Participate in fieldwork for data collection in coastal regions.
...
-   ***PhenoPhyto***- Developing a Python and R Library for Detecting Phytoplankton Blooms from Remote Sensing Data

-   Assessing Phytoplankton Variability in Response to The Extreme Sea Surface Temperature in the Bay of Bengal: An Approach of Satellite Oceanography

-   Comprehensive Assessment of Marine Biodiversity Vulnerability in Bangladesh’s Coastal Regions.
